...
const dashboardTableData: AdminTableItem[] = [
  {
    firstName: 'Roshane',
    lastName: 'Johnson',
    telephone: 18768745432,
    plumber: 'Jane Doe',
    issues: 0,
  },
];
...
export class AdminTableDataSource extends DataSource<AdminTableItem> {
  data: AdminTableItem[] = dashboardTableData;
  ...
  private getSortedData(data: AdminTableItem[]): AdminTableItem[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        ...
        case 'telephone':
          return compare(a.telephone, b.telephone, isAsc);
        case 'plumber':
          return compare(a.plumber, b.plumber, isAsc);
        case 'issues':
          return compare(a.issues, b.issues, isAsc);
        default:
          return 0;
      }
    });
